...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['itemID']) && isset($_POST['itemName']) && isset($_POST['itemPrice']) && isset($_POST['bulkPrice']) && isset($_POST['itemStock'])) {
        ...
        for ($i = 0; $i < count($_POST['itemID']); $i++) {
            ...
            // Update query
            $sql = "UPDATE items SET itemName='$itemName', itemPrice='$itemPrice', bulkPrice='$bulkPrice', itemStock='$itemStock' WHERE itemID='$itemID'";
